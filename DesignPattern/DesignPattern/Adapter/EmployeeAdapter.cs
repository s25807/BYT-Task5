...
namespace DesignPattern.Adapter
{
    public class EmployeeAdapter : ITarget
    {
        ...
        public void ProcessCompanySalary(string[,] employeesArray)
        {
            ...
            for (int i = 0; i < employeesArray.GetLength(0); ++i) employeesList.Add(new Employee(int.Parse(employeesArray[i, 0]), employeesArray[i, 1], employeesArray[i, 2],  decimal.Parse(employeesArray[i, 3])));
